...
ApiTaster.routes do
  ...
  desc <<HERE
    Layer.json Return a list of all Layers in JSON Format
HERE
  get '/layers', { :format => :json }

  desc <<HERE
    Create a new Layer and upload a GeoJSON file of Manhattan and return JSON
HERE
  post '/layers', {
    :layer => {
      :name => 'Manhattan-GeoJSON',
      :content => :file
    },
    :format => :json
  }
  ...
  desc <<HERE
#     Create a new Layer and upload a TopoJSON file of Manhattan and return JSON
HERE
  post '/layers', {
    :layer => {
      :name => 'TopoJSON-Manhattan',
      :content => :file
    },
    :format => :json
  }
  ...
  desc <<HERE
# # #     Create a new Layer and upload a Zip File (ShapeFile) of Manhattan and return JSON
HERE
  post '/layers', {
    :layer => {
      :name => 'Manhattan-Shapefile',
      :content => :file
    },
    :format => :json
  }
  ...
  desc <<HERE
# # #     Create a new Layer. You can upload GeoJSON, TopoJSON or ShapeFile(zip format) and return HTML
HERE
  post '/layers', {
    :layer => {
      :name => :name,
  ...
  desc <<HERE
# #      Return data about layer:id in GeoJSON
HERE
  get '/layers/:id', :id => 1, :format => :geojson

  desc <<HERE
# #      Return data about layer:id in TopoJSON
HERE
  get '/layers/:id', :id => 1, :format => :topojson


  desc <<HERE
    update a layer, supply a geojson file in post
HERE
  put '/layers/:id', :id => 1, :geo_file => :file
